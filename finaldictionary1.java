		...
		System.out.println("\n");
			...
			switch(choice){
				...
				if(!checkValidity(pp)){
					...
					System.out.println("Try again with correct word");					
					break;
				}
				...
				if(!checkValidity(mm)){
					System.out.println("meaning is invalid");
					System.out.println("Try again with correct meaning");					
					break;
				}
				...
				if(root==null)
				{
					System.out.println("There is no word in the dictionary yet.Therefore you cann't find the given string in dictionary");
				}
				else
				{
				...
				{
					System.out.println("Dictionary is empty.You cann't use inorder traversal");
				}
				...
				default:
				System.out.println("you have entered wrong option .Please entered right option\n");
				break;
			}
		}
	}
